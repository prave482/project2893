...
const ROLE_BLUEPRINTS: Record<string, RoleBlueprint> = {
  'AI Developer': {
    ...
    projects: [
      { title: 'AI Support Copilot', summary: 'Build a support assistant that retrieves knowledge, drafts answers, and escalates uncertain cases.', techStack: ['Python', 'FastAPI', 'Vector DB', 'OpenAI API'], steps: ['Prepare support knowledge sources', 'Implement retrieval and prompt flow', 'Add answer confidence checks', 'Measure response quality with test cases'], difficulty: 'Advanced', portfolioValue: 'Shows applied LLM engineering, API design, and evaluation discipline.' },
      { title: 'Resume Match Analyzer', summary: 'Create a tool that compares resumes against job descriptions and explains fit, risks, and skill gaps.', techStack: ['Python', 'SQL', 'React', 'LLM API'], steps: ['Parse candidate and role inputs', 'Build scoring and explanation logic', 'Add grounded recommendation generation', 'Track feedback on relevance'], difficulty: 'Intermediate', portfolioValue: 'Demonstrates AI product thinking with grounded output generation.' },
      { title: 'Meeting Notes Intelligence API', summary: 'Turn meeting transcripts into summaries, action items, and searchable decisions.', techStack: ['Node.js', 'PostgreSQL', 'LLM API', 'Next.js'], steps: ['Ingest transcript data', 'Generate structured outputs', 'Add evaluation cases for hallucination control', 'Ship a dashboard for reviewing results'], difficulty: 'Advanced', portfolioValue: 'Highlights end-to-end AI feature delivery and quality safeguards.' },
    ],
